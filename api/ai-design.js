...
요구사항:
- 항목은 2~3개만 작성하세요.
- 제목은 "대중교통", "자가용", "도보"처럼 짧게 작성하세요.
- 대중교통(지하철, 기차, 버스) 항목은 첫 줄에 하객이 내려야 할 최종 역/정류장 이름을 알려주세요. 예: "○○역 2번 출구에서 하차해 주세요." 정확한 역/정류장명을 모르면 "가까운 역(확인 필요)"처럼 적으세요.
- 그 역/정류장에서 예식장까지 도보 20분 이내로 이동 가능하면 도보 경로와 소요시간을 안내하세요.
- 도보 20분을 초과하거나 도보 이동이 어렵다면, 그 역/정류장에서 탑승해 예식장 근처까지 갈 수 있는 버스 번호를 줄을 나눠 안내하세요. 예: "버스: 000번, 00-1번 이용 시 예식장 근처에서 하차할 수 있어요."
- 버스 번호를 확실히 알 수 없으면 "버스 번호 확인 필요"라고 적으세요.
- 본문은 하객이 그대로 따라 할 수 있는 친절한 안내문으로 작성하세요.
- 처음 방문하는 하객도 이해할 수 있도록, 역/정류장 → 도보 또는 버스 → 도착 순서로 줄을 나눠 가독성 있게 작성하세요(최대 4~5줄).
- "정류장 하차", "주차장 이용", "도보 이동"처럼 명사형으로 끝나는 문장만 나열하지 마세요.
- 문장 끝은 "이용해 주세요", "확인해 주세요", "권장드립니다"처럼 정중한 안내형으로 작성하세요.
- 핵심 장소나 기준점은 괄호를 활용해 짧게 보충하세요. 예: 가까운 역(확인 필요)
- 차량, 버스, 지하철/기차, 도보 소요시간은 확실한 범위에서만 설명하고, 불확실하면 확인 필요라고 안내하세요.
- 한 줄에 여러 정보를 길게 나열하지 말고, 역/정류장명·도보 또는 버스 안내·소요시간·주의사항을 줄 단위로 나누세요.
