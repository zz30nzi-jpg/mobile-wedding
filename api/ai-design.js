...
- "셔틀버스": 1번째 줄은 운행 시간 또는 배차 간격, 2번째 줄은 탑승 장소를 안내하세요.
- "버스": 1번째 줄은 이용 가능한 버스 번호와 정류장, 2번째 줄은 하차 후 예식장까지 이동 방법을 안내하세요.
- "지하철": 1번째 줄은 가장 가까운 역과 출구 번호, 2번째 줄은 하차 후 예식장까지 이동 방법(도보 또는 택시)을 안내하세요.
- "도보": 1번째 줄은 출발 기준점에서 예식장까지의 경로, 2번째 줄은 도보 소요시간을 안내하세요.
- "자가용": 1번째 줄은 내비게이션 입력 방법이나 주요 경로, 2번째 줄은 주차 안내를 작성하세요.
- 정확한 역/정류장명, 버스 번호, 소요시간을 확실히 알 수 없으면 "확인 필요"라고 적으세요.
- 각 줄은 28자 안팎의 짧은 안내문으로 작성하세요.
- 문장 끝은 "이용해 주세요", "확인해 주세요"처럼 정중한 안내형으로 작성하세요.
