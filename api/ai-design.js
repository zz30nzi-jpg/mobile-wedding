...
- 예식장 인근 기차역·지하철역·버스정류장이 도보 20분 이내면 해당 역/정류장 이름을 직접 안내하세요. 기차역·지하철역이 도보 20분을 넘으면 그 역 이름 대신, 예식장 인근 버스정류장 이름과 그 역↔예식장 노선의 버스 번호로 안내하세요.
...
- "지하철": 가장 가까운 역이 도보 20분 이내면 1번째 줄에 그 역과 출구 번호 → 도보 시간(예: "OO역 1번 출구 → 도보 5분"), 2번째 줄은 예식장명을 적으세요. 도보 20분을 넘으면 1번째 줄에 예식장 인근 정류장 이름과 그 역↔예식장 노선 버스 번호(예: "OO정류장 ↔ OO역 100, 200"), 2번째 줄은 예식장 인근 하차 정류장과 도보 이동 시간을 적으세요.
