...
- "가능합니다", "참고", "공식 홈페이지", "블로그", URL, 전화번호, 출처명은 text 줄에 쓰지 마세요. 출처 설명은 하객 안내가 아니므로 제외하세요.
...
- 먼저 식장 기준 도보 20분 이내에 버스정류장과 철도역이 각각 있는지 판정하세요. 철도역은 지하철역을 우선하되, 주변에 지하철역이 없으면 기차역/KTX역/일반철도역으로 대체하세요. 이 판정이 버스/지하철 안내의 기준입니다.
- 도보 20분 이내 버스정류장이 있으면, "버스" 항목은 1줄: 해당 정류장 이름, 2줄: 정류장에서 식장까지 도보 N분으로 작성하세요.
- 도보 20분 이내 버스정류장이 없으면, "버스" 항목은 1줄: 도보 20분 이상인 인근 버스정류장 이름, 2줄: 그 정류장에서 위 철도역 또는 식장까지 타고 올 수 있는 버스 번호/타는 정류장, 3줄: 정류장에서 식장까지 택시 약 N분으로 작성하세요.
- 도보 20분 이내 철도역이 있으면, "지하철" 항목은 1줄: 해당 지하철역 호선/역명 또는 기차역 이름, 2줄: 역에서 식장까지 도보 N분으로 작성하세요.
- 도보 20분 이내 철도역이 없으면, "지하철" 항목은 1줄: 인근 지하철역 또는 기차역 이름, 2줄: 그 역에서 위 버스정류장 또는 식장까지 타고 올 수 있는 버스 번호/타는 정류장, 3줄: 역에서 식장까지 택시 약 N분으로 작성하세요.
...
- 식장 기준 도보 20분 이내 철도역 존재 여부, 지하철역 우선 호선/역명, 지하철역이 없으면 기차역/KTX역/일반철도역 이름, 도보 소요시간
- 도보 20분 이내 버스정류장만 있으면, 인근 지하철역 또는 기차역에서 해당 정류장 또는 식장까지 오는 버스 번호/타는 정류장과 택시 소요시간
- 도보 20분 이내 철도역만 있으면, 인근 버스정류장에서 해당 역 또는 식장까지 오는 버스 번호/타는 정류장과 택시 소요시간
